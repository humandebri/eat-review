            ...
            <div className="flex items-center gap-2">
              {loading ? (
                ...
                <>
                  ...
                  {/* 管理者ボタン（管理者のみ表示） */}
                  {user.key === 'xc3ky-ucw5v-tmdxu-fq5vu-ybydk-xfgb2-zyfbm-batpk-fu6a5-gikpn-gqe' && (
                    <Link
                      href="/admin"
                      className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-purple-700 dark:text-purple-300 hover:text-purple-900 dark:hover:text-purple-100 transition-colors rounded-lg hover:bg-purple-100 dark:hover:bg-purple-800"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
